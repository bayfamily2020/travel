...
const MEDIA_CACHE_KEY = "world-travel-650-media-v20";
...
document.addEventListener("DOMContentLoaded", async () => {
  try {
    const chunks = await Promise.all(Array.from({length:13}, (_,i) => fetch(`./data-${i}.json?v=20260818-189-582`).then(r => r.json())));
    places = chunks.flat();

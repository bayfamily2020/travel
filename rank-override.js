...
const travelDiagnoses = {
  ...
  "航站楼真菌":"在登机口恒温空调里滋生，离了机场广播就会枯竭。",
  "旷野视觉饥饿症":"对城市霓虹过敏，必须定期用荒原与雪山给眼睛做保健。",
  "跨国流窜犯":"经常国界外，朋友圈定位具有较强迷惑性。",
  "漂流的海龟":"顺着大洋洋流与固定航线，不慌不忙地漂过半个地球。",
  "进击的风光巨人":"吞噬风景为食物，一口气就能吃下整条海岸线与山脉。",
  "机场贵宾室寄生虫":"把贵宾厅当精神母胎，靠免费热食与升舱里程续命。",
  "地球街溜子":"把五大洲当自家胡同，双手插兜在哪都能熟门熟路。",
  "人形行李箱":"出门极简，随时能把自己打包扔进下一个货舱。",
  "徐·波罗+马可·霞客":"缝合级游侠，既能荒野徒步，又能考察异域文明。",
  "伊本·白图泰":"骨灰级史诗行者，用脚步在古代荒原与大陆间刻下史诗。",
  "洄游的灰鲸":"跨洋级顶级行者，享受孤独、宏大且无定所的终极巡游。",
  "地球全景渲染侠":"地表地图已近全境加载，正催促造物主更新太空DLC。",
  "外星人卧底":"地表考察全部圆满，正准备给母星发送最终殖民坐标。"
};
...
updateSummary = function() {
  ...
  const level = progress >= 92 ? "外星人卧底" : levels.find(([limit]) => progress < limit)[1];
